...
const Lieferservice = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Deutschlandweite Heizöl-Lieferung | 4-7 Werktage | AHI-Energie"
        ...
        canonicalUrl="https://ahi-energie.de/lieferservice"
      />
      <Header />
      ...
      <PageSection className="py-24" background="warm">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Warum AHI-Energie?</h2>
